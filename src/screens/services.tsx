  ...
  return (
    <div className="services">
      ...
      >
        <h1>Expertise</h1>
        <p>
          North Fork Solutions offers comprehensive digital services designed to help businesses grow. From brand strategy to web development, from marketing plans to choosing the right systems and software, Anelise brings expert knowledge to every stage of the process. The approach to every project starts with a deep understanding of the heart of the problem, and my process is creative, collaborative, and transparent. AI and automation will be used to speed up delivery or improve your business's workflows, but never at the expense of quality or individuality.
        </p>
        <p>
          Looking to build something big? Don't worry, it's not just me behind the scenes. I have a large network of talented designers, back-end developers, content creators, and many other industry experts that are ready to team up and deliver your dreams to reality.
        </p>
        <Skills />
      </div>
      <ImageText
